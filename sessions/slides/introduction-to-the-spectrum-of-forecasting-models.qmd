...
1. Load forecasts from three models of different levels of mechanism and statistical complexity.
2. Evaluate the forecasts using proper scoring rules

#

[Return to the session](../forecast-evaluation-of-multiple-models)
